...
if st.session_state.page == "add":
    st.subheader("Cadastrar novo EXCESSO VELOCIDADE - FROTA")
...
if st.session_state.page == "edit":
    st.subheader("🔍 Buscar licenciamento por frota")

    bp_busca = st.text_input("Digite o Nº do Frota")
    ...
    if st.session_state.get("registro_encontrado"):
        ...
        with col2:
            if st.button("Excluir registro"):
                deletar_registro_por_placa(frota_original)
